...
<li>📚 I am curious by nature and have a genuine passion for learning new things. This is an inclination that continues to enrich my life and is one of the reasons I found myself drawn to software development. There are so many opportunities to learn, grow and connect with others.</li>
<li>🌲 Connecting with nature is important to me. Whether it be on a trail, summiting a mountain, exploring the waters by kayak, or biking through the woods. It all brings a great sense of restoration and peace. </li>
<li>🗻 Hiking also has a notable crossover to development and that’s how you react when faced with a challenge. There are always options - you can persist, take a break, seek alternate routes, ask for help, or even turn back. No matter which you choose they’ll all offer valuable insights, but there’s nothing quite like the feeling of reaching the summit or solving that problem.</li>
<li>Also, 🐈,🏋️,📷,🎨,🧶,🎧,🌱,🌌. </li>
</ul>
